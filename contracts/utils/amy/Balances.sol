...
library Balances {
  ...
  function balanceOf(Fungible storage self, address account)
    internal
    view
    returns (uint256)
  {
  ...
  function ownerOf(NonFungible storage self, uint256 tokenid)
    internal
    view
    returns (address)
  {
  ...
  function balanceOf(NonFungibleEnumerable storage self, address account)
    internal
    view
    returns (uint256)
  {
  ...
  function at(
    NonFungibleEnumerable storage self,
    address account,
    uint256 idx
  ...
  function totalSupply(NonFungibleEnumerable storage self)
    internal
    view
    returns (uint256)
  {
  ...
  function at(NonFungibleEnumerable storage self, uint256 idx)
    internal
    view
    returns (uint256)
  {
  ...
  function ownerOf(NonFungibleEnumerable storage self, uint256 tokenid)
    internal
    view
    returns (address)
  {
