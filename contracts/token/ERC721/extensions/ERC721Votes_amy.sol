...
import '../../../utils/amy/WithNonce.sol';
import '../../../utils/amy/Voting.sol';

bytes32 constant _DELEGATION_TYPEHASH = keccak256(
  'Delegation(address delegatee,uint256 nonce,uint256 expiry)'
);

abstract contract ERC721Votes_amy is ERC721, WithNonce {
